...
(()=>{
    const e = new Error("Cannot find module '../actions/executeCode'");
...
function IDE() {
    ...
    const execute = async (code, language)=>{
        setIsExecuting(true);
        try {
            const job_id = await actions.executeCode(code, language);
    ...
    const get_job_result = (job_id)=>{
        try {
            const result = await actions.getJob(job_id);
        }
    };
...
//# sourceMappingURL=_8d20ccba._.js.map