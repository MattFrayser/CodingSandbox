...
"[project]/app/actions/executeCode.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$executeCode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/executeCode.ts [app-client] (ecmascript)");
;
...
function IDE() {
    ...
    const execute = async (code, language)=>{
        setIsExecuting(true);
        try {
            const job_id = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$executeCode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeCode"])(code, language);
            if (job_id.message === "Job queued") {
                setOutput((prev)=>[
                        ...prev,
                        "Executing. . ."
                    ]);
                ...
                setOutput((prev)=>[
                        ...prev,
                        ...Array.isArray(job_id.message) ? job_id.message : [
                            job_id.message
                        ],
                        `Execution finished with exit code ${job_id.exitCode || 0}`
                    ]);
            }
        } catch (err) {
            setOutput((prev)=>[
    ...
    const get_job_result = (job_id)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$executeCode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getJob"])(job_id);
        }
    };
...
_s(IDE, "/sq8KYEd/VKZQ6pTGW5L224LGME=");
_c = IDE;
var _c;
...
//# sourceMappingURL=_39e4c985._.js.map