...
async function executeCode(code) {
    try {
        ...
        throw new Error(axiosError.response?.data?.message || 'Failed to execute code');
    }
}
}}),
...
function IDE() {
    ...
    const execute = async (code)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["executeCode"])(code);
            setOutput((prev)=>[
                    ...prev,
                    ...result.output.split("\n"),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14eb9dea._.js.map