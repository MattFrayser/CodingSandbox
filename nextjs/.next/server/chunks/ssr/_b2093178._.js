...
"[project]/app/actions/executeCode.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$executeCode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/executeCode.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function IDE() {
    ...
    const execute = async (code, language)=>{
        setIsExecuting(true);
        try {
            const job_id = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$executeCode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["executeCode"])(code, language);
    ...
    const get_job_result = (job_id)=>{
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$executeCode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getJob"])(job_id);
        }
    };
...
//# sourceMappingURL=_b2093178._.js.map